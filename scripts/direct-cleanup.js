// Direct cleanup script - run with: node scripts/direct-cleanup.js
const { createClient } = require('@supabase/supabase-js');

const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://pytehpdxophkhuxnnqzj.supabase.co';
const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY; // Need this from env
...
async function cleanupPendingDuplicates() {
    ...
    if (failedCount > 0) {
        console.log(`   ⚠️  Failed to delete ${failedCount} posts`);
    }
}
