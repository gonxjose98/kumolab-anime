...
import { Image as ImageIcon, Pencil, Library } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
            ...
            {rows.length === 0 ? (
                <div className="ak-empty">
                    ...
                    <p className="ak-body-sm">No image work in progress. Open a piece from the <strong>Library</strong> to edit its card, overlays &amp; caption.</p>
