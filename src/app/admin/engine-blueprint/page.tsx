...
/**
 * /admin/engine-blueprint — the redesigned Engine tab.
 *
 * Preview route. The live /admin/engine is untouched until this is signed off,
 * the same way the sea-to-sky redesign shipped.
 *
...
export default async function EngineBlueprintPage() {
    const [tiers, formula, goals, slots, queue, runs, faultState, health] = await Promise.all([
        getAnimeTiers().catch(() => []),
        getPostFormula(),
        getProjectGoals(),
        getPeakSlots(),
