...
export const metadata: Metadata = {
    title: 'KumoLab — Terms of Service (Redesign Preview: Content Sky)',
    description:
        "Preview of KumoLab's Terms of Service on the content-page sky theme. Legal copy unchanged.",
    robots: { index: false, follow: false },
};

/**
 * /redesign-legal/terms — non-destructive themed preview of the terms
 * of service. Legal copy carried over VERBATIM from
 * src/app/terms/page.tsx; only the presentation changes.
 * Never touches /terms.
 */
export default function RedesignTermsPage() {
    return (
        <SkyContentRoot>
            <header className={styles.hero}>
                <p className={styles.kicker}>利用規約 · The Ground Rules, Sky High</p>
